...
VELOCITY_FORWARD = 1600     # PWM-Wert fuer fahren
VELOCITY_ZERO = 1500        # PWM-Wert fuer halten
BURST = 10                  # Anzahl Messwerte fuer 
go = 0
st = 0
...
class steeringcontrolnode:
    ...
    def __init__(self, node_name, sub_topic1, sub_topic2, pub_topic):
        ...
        rate = rospy.Rate(30) #publish Rate wird auf  Hz gesetzt, da Kamera maximal 25 Bilder/s liefert
