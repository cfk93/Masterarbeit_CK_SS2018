...
class imagestopsignnode:
    ...
    def callback(self, data):
        #rate = rospy.Rate(100) #publish Rate wird auf 25 Hz gesetzt, da Kamera maximal 25 Bilder/s liefert
        #rate.sleep()    # Schleife entsprechend der publish rate, um Wiederholungsfrequenz einzuhalten
	...
	for (x,y,w,h) in stops:
            ...
            cv2.putText(image_gray, "Breite: %.2fpx" % (w), (350, 40), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
