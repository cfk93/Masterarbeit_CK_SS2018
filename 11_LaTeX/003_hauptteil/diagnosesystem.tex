...
\begin{figure}[!htbp]
	...
	\node (interface)   [block3] at (\textwidth-6cm,4) {CANcaseXL Interface};
...
\begin{figure}[!hbt]
	\centering
	\includegraphics[width=\textwidth]{./DBC_Beispiel_ultraschall_data}
...
\begin{figure}[!hbt]
	\centering
	\includegraphics[width=\textwidth]{./Diagnose_Panel}
...
% Zeitkritisch? Echtzeit? Dauer der Verarbeitung, Wiederholungsrate der Sensorsignale, Rechenleistung, Synchronisation, Berechnung Größe aller Variablen und Summe Bytes der CAN-Frames, Vergleich mit Datenrate CAN um auf Echtzeitfähigkeit zu kommen. Busauslastung? Erst ohne Timing und dann Vorteil von Timing: Unnötige Datenübertragung reduzieren, Busauslastung senken

Nachdem die Datenübertragung und Ausgabe der Signale umgesetzt wurde, soll das angewandte Verfahren getestet und auf seine Tauglichkeit geprüft werden.\\
...
\begin{figure}[!htbp]
	\centering
	%\missingfigure[figwidth=\textwidth, figheight=0.4\textheight]{An dieser Stelle wird der Plot des CAN Differenzsignals geplottet.}
	...
	ymin=0,ymax=4,
	ytick distance=0.5,
	xlabel={Zeit \emph{t} in $\mu$s},
	ylabel={Spannung \emph{U} in V},
	legend entries = {CAN-High,CAN-Low},
	legend pos=south east, legend cell align={left},
	grid = major,
	grid style={dashed, gray!30},
	]
	\addplot+[mark=none,each nth point=2]
	table[x=Zeit,y=KanalA, y expr=\thisrow{KanalA}*0.1] {007_data/Scope_ID10.txt};
	\addplot+[mark=none,each nth point=2]
	table[x=Zeit,y=KanalB, y expr=\thisrow{KanalB}*0.1] {007_data/Scope_ID10.txt};
	\end{axis}
	\end{tikzpicture}
